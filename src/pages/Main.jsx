...
const Main = () => {
  ...
  const [changeInfo, useChangeInfo] = useState(
    "Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum autem reprehenderit a quae consectetur, accusantium veritatis quidem, aperiam asperiores velit qui dolorem non, ea maiores quaerat neque fugit corporis expedita."
  );
  ...
  const menuItems = [
    {
      src: "../../public/nikeAirShoe.png",
      name: "Motese",
      price: "$Free",
      status: "Start Game",
      info: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Praesentium, facilis eum? Est debitis harum earum atque totam. Distinctio nobis quibusdam ab aspernatur explicabo consequuntur sequi dolorum? Neque aut suscipit alias!",
    },
    {
